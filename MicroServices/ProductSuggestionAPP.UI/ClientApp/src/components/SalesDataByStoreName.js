...
export default class SalesDataByStoreName extends Component {
    static displayName = "SalesData By StoreName";
    ...
    render() {
        let contents = this.state.loading
            ? <p><em>Loading...</em></p>
            : SalesDataByStoreName.renderallSalesDataTable(this.state.allSalesData);
