...
export default class GetProdcutSuggestionByUserId extends Component {
    static displayName = "GetProdcut Suggestion By UserId";
    ...
    render() {
        let contents = this.state.loading
            ? <p><em>Loading...</em></p>
            : GetProdcutSuggestionByUserId.renderallSalesDataTable(this.state.allSalesData);
